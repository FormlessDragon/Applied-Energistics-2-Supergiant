...
/**
 * Import context variant matching AdvancedAE's filtered import behavior.
 */
class FilteredImportStackTransferContext implements StackTransferContext {
    ...
    FilteredImportStackTransferContext(IStorageService internalStorage, IEnergySource energySource,
