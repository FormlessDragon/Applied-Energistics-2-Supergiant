...
public enum GuiText implements LocalizationEnum {
    ...
    AdvancedMemoryCardInput("advanced_memory_card.input"),
    AdvancedMemoryCardOutput("advanced_memory_card.output"),
    ...
    AdvancedMemoryCardModeHint("advanced_memory_card.mode_hint"),
