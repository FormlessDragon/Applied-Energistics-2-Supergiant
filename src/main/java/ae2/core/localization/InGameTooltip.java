...
public enum InGameTooltip implements LocalizationEnum {
    ...
    StockExportBusLine2,
    StockExportBusLine3,
    ImportExportBusLine1,
    ImportExportBusLine2,
    ImportExportBusLine3,
    AdvancedIOBusLine1,
    AdvancedIOBusLine2,
    AdvancedIOBusLine3,
    BeamFormerRange,
    BeamFormerPartChannels,
    BeamFormerDenseChannels,
    BeamFormerWrenchToggle,
